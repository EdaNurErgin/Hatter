...
<section  class="admin-feature-section">
  <div class="admin-feature-container">
    <div class="admin-feature-box">
      ...
      <a href="/hatter/AdminPanel/ContactandPageSettings/ContactMessages/index.php" class="admin-feature-btn">Open Panel</a>
    </div>
    <div class="admin-feature-box">
      <h3>About Us Editing</h3>
      <a href="/hatter/AdminPanel/ContactandPageSettings/AboutUsEditing/index.php" class="admin-feature-btn">Open Panel</a>
    </div>
    <div class="admin-feature-box">
      <h3>Homepage Management</h3>
      <a href="/hatter/AdminPanel/ContactandPageSettings/HomepageManagament/index.php" class="admin-feature-btn">Open Panel</a>
    </div>
