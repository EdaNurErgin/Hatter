...
<section  class="admin-feature-section">
  <div class="admin-feature-container">
    <div class="admin-feature-box">
      ...
      <a href="/hatter/AdminPanel/UserContentControl/userManagement/index.php" class="admin-feature-btn">Open Panel</a>
    </div>
    <!-- <div class="admin-feature-box">
    ...
    <div class="admin-feature-box">
      ...
      <a href="/hatter/AdminPanel/UserContentControl/blogContentManagement/index.php" class="admin-feature-btn">Open Panel</a>
    </div>
